...
If asked about a specific order not in the list, say you don't have data for that order number.`;
    ...
    console.log("Calling Google AI with context...");
    ...
    const contents = [
      ...
      { role: "model", parts: [{ text: "I understand. I'm ready to help you manage your window and door manufacturing orders. How can I assist you today?" }] },
      ...googleMessages
    ];
